...
import (
	...
	"github.com/ddh-open/gin/framework/gin/internal/bytesconv"
	"html/template"
	"net"
	"net/http"
	"os"
...
func (engine *Engine) Run(addr ...string) (err error) {
	...
	if engine.isUnsafeTrustedProxies() {
		debugPrint("[WARNING] You trusted all proxies, this is NOT safe. We recommend you to set a value.\n" +
			"Please check https://pkg.go.dev/github.com/ddh-open/gin#readme-don-t-trust-all-proxies for details.")
	}
